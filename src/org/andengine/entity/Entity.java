...
public class Entity implements IEntity {
    ...
    /**
     * @param pAlpha from <code>0.0f</code> (transparent) to <code>1.0f</code>
     *            (opaque)
     */
    @Override
    ...
    /**
     * @param pGLState the currently active {@link GLState} i.e. to apply
     *            transformations to.
     * @param pCamera the currently active {@link Camera} i.e. to be used for
     *            culling.
     */
    ...
    protected void onManagedDraw(final GLState pGLState, final Camera pCamera) {
        pGLState.pushModelViewGLMatrix();
        {
            ...
            if ((this.mChildren == null) || !this.mChildrenVisible) {
                ...
                @SuppressWarnings("unchecked")
                final SmartList<IEntity> children = (SmartList<IEntity>) this.mChildren.clone();
